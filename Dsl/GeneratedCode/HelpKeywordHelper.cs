...
namespace UPM_IPS.GVSJGGGASLProyectoIPS
{
	...
	/// </remarks>
	public partial class GVSJGGGASLProyectoIPSHelpKeywordHelper : GVSJGGGASLProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected GVSJGGGASLProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the GVSJGGGASLProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static GVSJGGGASLProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class GVSJGGGASLProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected GVSJGGGASLProyectoIPSHelpKeywordHelperBase()
			: base() { }
