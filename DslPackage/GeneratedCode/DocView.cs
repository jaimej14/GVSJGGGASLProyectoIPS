...
namespace UPM_IPS.GVSJGGGASLProyectoIPS
{
	...
	/// </summary>
	internal partial class GVSJGGGASLProyectoIPSDocView : GVSJGGGASLProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSDocView.
		/// </summary>
		public GVSJGGGASLProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class GVSJGGGASLProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSDocView.
		/// </summary>
		protected GVSJGGGASLProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			GVSJGGGASLProyectoIPSDocDataBase docData = this.DocData as GVSJGGGASLProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for GVSJGGGASLProyectoIPSDocViewBase should be an GVSJGGGASLProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.GVSJGGGASLProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.GVSJGGGASLProyectoIPS.GVSJGGGASLProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
