...
namespace UPM_IPS.GVSJGGGASLProyectoIPS
{
	...
	/// </summary>
	internal partial class GVSJGGGASLProyectoIPSCommandSet : GVSJGGGASLProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSCommandSet.
		/// </summary>
		public GVSJGGGASLProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class GVSJGGGASLProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSCommandSetBase.
		/// </summary>
		protected GVSJGGGASLProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewGVSJGGGASLProyectoIPSExplorerCommand,
				typeof(GVSJGGGASLProyectoIPSEditorFactory).GUID);
		...
		{
			GVSJGGGASLProyectoIPSExplorerToolWindow explorer = this.GVSJGGGASLProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected GVSJGGGASLProyectoIPSDocData CurrentGVSJGGGASLProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as GVSJGGGASLProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected GVSJGGGASLProyectoIPSDocView CurrentGVSJGGGASLProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as GVSJGGGASLProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected GVSJGGGASLProyectoIPSExplorerToolWindow GVSJGGGASLProyectoIPSExplorerToolWindow
		{
			get
			{
				GVSJGGGASLProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(GVSJGGGASLProyectoIPSExplorerToolWindow), true) as GVSJGGGASLProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				GVSJGGGASLProyectoIPSExplorerToolWindow explorerWindow = this.GVSJGGGASLProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class GVSJGGGASLProyectoIPSClipboardCommandSet : GVSJGGGASLProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSClipboardCommandSet.
		/// </summary>
		public GVSJGGGASLProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class GVSJGGGASLProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new GVSJGGGASLProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected GVSJGGGASLProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
